...
function showSortDialog(): void {
    globalBottomSheet.openBottomSheet(
        GuestSortOptions,
        {
            ...
            "onUpdate:currentSortOption"(newVal: SortOption) {
                setSortOption(newVal);
            },
            "onUpdate:selectedTags"(newVal: string[]) {
                ...
                >
                    ...
                    <v-list-item-title>
                        <div class="d-flex align-center">
                            <span aria-label="Guest name">{{ item.name }}</span>
                            <v-spacer />
