...
describe("EventCreateForm", () => {
    describe("create", () => {
        ...
        it.todo("emits create event with correct payload", async () => {
            const screen = renderComponent(EventCreateForm, props);
    ...
    describe("edit", () => {
        ...
        it.todo("renders the form with event data", async () => {
            const screen = renderComponent(EventCreateForm, props);
            await expect
        ...
        it.todo("emits update event with correct payload", async () => {
            const screen = renderComponent(EventCreateForm, props);
