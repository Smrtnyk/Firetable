        ...
        <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-6">
                <q-card class="bg-primary text-white ft-card">
                    <q-card-section>
                        <div class="text-h6">{{ t('AdminEventRTInfo.titles.capacityOverview') }}</div>
                        <div class="row items-center q-gutter-x-md">
                            ...
                            <div class="column">
                                <div aria-label="tables occupied">
                                    ...
                                    {{ reservationsStatus.total }} {{ t('AdminEventRTInfo.labels.tables') }}
                                </div>
                                <div aria-label="pending reservations">
                                    {{ reservationsStatus.pending }} {{ t('AdminEventRTInfo.labels.pending') }}
                                </div>
                            </div>
                        </div>
                    </q-card-section>
            ...
            <div class="col-12 col-md-6">
                <q-card class="bg-secondary text-white ft-card">
                    <q-card-section>
                        <div class="text-h6">{{ t('AdminEventRTInfo.titles.guestStatistics') }}</div>
                        <div class="row items-center q-gutter-x-md">
                            ...
                            <div class="column">
                                ...
                                <div aria-label="guest contact rate">
                                    {{ contactRate }}% {{ t('AdminEventRTInfo.labels.withContactsSuffix') }}
                                </div>
                            </div>
                        </div>
                    </q-card-section>
            ...
            <div class="col-12 col-md-4">
                <q-card class="ft-card">
                    <q-card-section>
                        <div class="text-subtitle2">{{ t('AdminEventRTInfo.labels.vipGuests') }}</div>
            ...
            <div class="col-12 col-md-4">
                <q-card class="ft-card">
                    <q-card-section>
                        <div class="text-subtitle2">{{ t('AdminEventRTInfo.labels.returningGuests') }}</div>
            ...
            <div class="col-12 col-md-4">
                <q-card class="ft-card">
                    <q-card-section>
                        <div class="text-subtitle2">{{ t('AdminEventRTInfo.labels.avgConsumption') }}</div>
