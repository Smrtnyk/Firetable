...
const canAddFloor = computed(() => {
    return remainingFloors.value > 0;
});
    ...
    <div class="event-floor-manager ma-0">
        <div v-if="availableFloors?.length" class="d-flex align-center justify-space-between mb-4">
            ...
            <v-menu>
                    ...
                    <v-tooltip location="top">
                        <template #activator="{ props: tooltipActivatorProps }">
                            <div
                                ...
                                v-bind="remainingFloors <= 0 ? tooltipActivatorProps : {}"
                            >
                                <v-btn
                                    v-bind="
                                        remainingFloors <= 0
                                            ? menuActivatorProps
                                            : { ...menuActivatorProps, ...tooltipActivatorProps }
                                    "
                                    rounded
                                    :size="buttonSize"
                                    icon="fa fa-plus"
                ...
                <v-list class="ft-card" aria-label="Floor plans list">
                    <v-list-item
        ...
        <div
            ...
            style="gap: 8px"
            aria-label="Selected floor plans"
        >
            <div
