...
function calculateRegularPrice(bundle: DrinkBundle): number {
    return bundle.items.reduce(function (total, bundleItem) {
        const item = itemsMap.value.get(bundleItem.drinkCardItemId);
...
<template>
    ...
    >
        ...
        <div class="drink-card-content q-pa-sm q-pa-md-md">
            <q-img v-if="props.logoImgUrl" :src="props.logoImgUrl" class="logo-img" />

            <template v-for="{ element, isGrouped } in organizedElements" :key="element.id">
                <div :class="{ 'header-group': isGrouped }">
                    <template v-if="isHeader(element)">
                        <div :class="[isMobile ? 'text-h6' : 'text-h4', 'neon-text', 'q-mb-lg']">
                            {{ element.name }}
                        </div>
                    </template>
                                ...
                                <div class="bundle-content">
                                    <div class="bundle-items q-mb-md">
                                        <div
                                            ...
                                            :key="item.drinkCardItemId"
                                        >
                                            {{ item.quantity }}x
                                            {{ getItemName(item.drinkCardItemId) }}
                                        </div>
                                    </div>
...
.neon-text {
    ...
    text-shadow:
        ...
        0 0 10px #fff,
        0 0 21px #fff,
        0 0 22px rgb(250, 82, 222),
        0 0 42px rgb(250, 82, 222),
        0 0 62px rgb(250, 82, 222);
...
.header-group {
    border-left: 2px solid rgba(250, 82, 222, 0.6);
    margin-bottom: 2rem;
    padding-left: 2rem;
...
@keyframes neonPulse {
    ...
    to {
        text-shadow:
            ...
            0 0 21px #fff,
            0 0 42px rgb(250, 82, 222),
            0 0 82px rgb(250, 82, 222),
            0 0 92px rgb(250, 82, 222);
    }
}
