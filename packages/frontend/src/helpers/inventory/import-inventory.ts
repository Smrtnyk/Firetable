...
const inventoryItemTypeEnumValues = Object.values({ ...InventoryItemType });
// @ts-expect-error -- works fine
const drinkMainCategoryEnumValues = Object.values({ ...DrinkMainCategory });
// @ts-expect-error -- works fine
const retailMainCategoryEnumValues = Object.values({ ...RetailMainCategory });
