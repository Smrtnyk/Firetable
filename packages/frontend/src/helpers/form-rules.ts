...
export function noEmptyString(msg = i18n.global.t('helpers.formRules.noEmptyString')): (val: string) => boolean | string {
    return function (val: string): boolean | string {
...
export function validOptionalURL(msg = i18n.global.t('helpers.formRules.validOptionalURL')): (val: string) => boolean | string {
    return function (val: string): boolean | string {
        if (val === "") {
            return true;
        }
