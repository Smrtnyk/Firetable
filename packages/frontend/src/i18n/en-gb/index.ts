export default {
    Global: {
        ...
        invalidPriceStep: "Price must be in 0.50 steps",
    },
    useReservations: {
    ...
    PageAdminPropertyDrinkCards: {
        ...
        itemsLabel: "Items",
        sectionAlreadyExists: "A section with this category already exists",
        noSectionsMessage: "No sections added yet. Click + to add a section.",
        noItemsMessage: "No items in this section. Click + to add items.",
        noAvailableItems: "No items available for this category",
        ...
        softDrinksSection: "Soft Drinks",
        beerSection: "Beer Section",
        wineSection: "Wine Section",
        bottlesSection: "Bottles",
        shotsSection: "Shots",
        predefinedSections: "Predefined Sections",
        customSection: "Custom Section",
        cocktailsSection: "Cocktails",
