export default {
    ...
    InventoryItemCreateForm: {
        nameInputLabel: "Name *",
        nameInputHint: "Name of the item",
        typeInputLabel: "Type *",
        typeInputHint: "Type of the item",
        categoryInputLabel: "Category",
        categoryInputHint: "Category of the item",
        priceInputLabel: "Price *",
        priceInputHint: "Price per unit",
        quantityInputLabel: "Quantity *",
        quantityInputHint: "Quantity in stock",
        unitInputLabel: "Unit *",
        unitInputHint: "Unit of measurement",
        supplierInputLabel: "Supplier",
        supplierInputHint: "Supplier name",
        alcoholContentInputLabel: "Alcohol Content",
        alcoholContentInputHint: "Alcohol percentage",
        volumeInputLabel: "Volume",
        volumeInputHint: "Volume in ml or l",
        submitButtonLabel: "Submit",
        resetButtonLabel: "Reset",
    },
};
