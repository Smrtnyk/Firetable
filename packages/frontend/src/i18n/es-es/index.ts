export default {
    ...
    useReservations: {
        ...
        copyingReservationOperationMsg: "Copiando reservacion de la mesa {tableLabel}",
        ...
        reservationAlreadyReserved: "Alguien mas ya reservó esta mesa",
        moveReservationToQueueConfirmTitle:
            "¿Estás seguro de que quieres mover esta reservación a la cola?",
        transferReservationConfirmTitle: "Estás seguro de que quieres transferir esta reservación?",
        transferReservationConfirmMessage:
            "Esto tranferirra la reservación de la mesa {table1Label} a la mesa {table2Label}",
        ...
        reservationCopyErrorMsg: "Error al copiar la reservación, intenta de nuevo",
        linkTableTitle: "Vincular Mesa",
        linkTableConfirmMsg: "¿Estas seguro de que quieres vincular estas mesas: {tablesToLink}?",
        ...
        linkingTableOperationMsg: "Vinculando mesas a reservacion: {tableLabels}",
        unlinkConfirmTitle: "Desvincular mesas",
        unlinkConfirmMessage: "Estas seguro de que quieres desvincular estas mesas: {table}?",
    ...
    PageProfile: {
        ...
        passwordInputEnabledTitle: "Deshabilitar input",
        passwordInputDisabledTitle: "Habilitar input",
    ...
    PageIssueReport: {
        ...
        categoryLabel: "Categoría de problema",
