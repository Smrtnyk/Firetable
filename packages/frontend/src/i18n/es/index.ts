...
const es: TranslationStructure = {
    ...
    FTTimeframeSelector: {
        dateRangePlaceholder: "AAAA-MM-DD ~ AAAA-MM-DD",
        errorEndDateBeforeStartDate: "La fecha de fin no puede ser anterior a la fecha de inicio.",
        errorInvalidPreset: "Preajuste no válido: {preset}",
        errorMaxDays: "El rango de fechas no puede ser mayor a {maxDays} días.",
        errorSelectDates: "Por favor, selecciona fecha de inicio y fin.",
        errorSelectEndDate: "Por favor, selecciona una fecha de fin.",
